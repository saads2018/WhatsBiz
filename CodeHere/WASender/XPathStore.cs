...
namespace WASender
{
    ...
    {
        //public static string GMap_Result = "//div[contains(@jsname,'GZq3Ke')] | //div[contains(@jscontroller,'AtSb')] ";
        //public static string GMap_Result = "//div.uMdZh";

        public static string GMap_Result = "//div[contains(@class,'uMdZh')]";
        ...
        public static string GMap_Rating = "//span[contains(@class,'Aq14fc')]";
