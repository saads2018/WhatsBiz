...
namespace WASender
{
    public partial class ChooseGroupContacts : UserControl
    {
        ...
        private void createItem(int location, GroupContact contact, int count, string entry1, string entry2, int cond)
        {
            ...
            label0.Location = new System.Drawing.Point(label01.Location.X + (label8.Location.X - label6.Location.X) + (cond == 0 || cond == 2 ? label8.Size.Width / 3 : 0), 31);
            ...
            button1.Location = new System.Drawing.Point((cond == 1 || cond == 3 ? borderPanel.Width - 40 - button1.Width : label0.Location.X) + (cond == 1 || cond == 3 ? 0 : label3.Location.X - label8.Location.X), 31);
